            ...
            <div className="flex flex-col items-center text-center space-y-8 md:space-y-10 lg:space-y-12">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground text-lg md:text-xl max-w-[600px] mx-auto leading-relaxed">
                  Submit design requests whenever you need them. Our subscription model ensures you get quality design work without the hassle.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-6">
                <Link href="/auth/signup">
                  <Button size="lg" className="px-8 py-4 text-base font-medium rounded-xl shadow-soft hover:shadow-soft-lg transform hover:-translate-y-0.5 transition-all duration-200">
                    Get Started
                  </Button>
                </Link>
                <Link href="#how-it-works">
                  <Button size="lg" variant="outline" className="px-8 py-4 text-base font-medium rounded-xl hover:shadow-soft transform hover:-translate-y-0.5 transition-all duration-200">
                    Learn More
                  </Button>
                </Link>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mt-16">
              ...
              <div className="flex flex-col items-center text-center p-8 bg-card rounded-2xl shadow-soft hover:shadow-soft-lg transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 className="text-xl font-semibold mb-4">Designer Assignment</h3>
                <p className="text-muted-foreground leading-relaxed">
